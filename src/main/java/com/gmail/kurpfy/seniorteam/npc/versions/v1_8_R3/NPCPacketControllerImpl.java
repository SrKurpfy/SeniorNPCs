package com.gmail.kurpfy.seniorteam.npc.versions.v1_8_R3;
...
public class NPCPacketControllerImpl extends NPCPacketController {
    ...
    public void crouch(byte data) {
        ...
        PacketPlayOutEntityMetadata packet = new PacketPlayOutEntityMetadata(entityPlayer.getId(), dataWatcher, false);
